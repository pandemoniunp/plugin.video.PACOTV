# -*- coding: utf-8 -*-
#------------------------------------------------------------
# HarryTV parser de mebuscan.net
...
def mebuscan(params):
    plugintools.log("[HarryTV].Mebuscan.net( "+repr(params))
    plugintools.add_item(action="", title = '[B][I][COLOR lightyellow]Mebuscan.net Acestream Sports Playlist[/B][/I][/COLOR]', url = "", thumbnail = thumbnail , fanart = fanart , folder = False, isPlayable = False)    
...
def mebuscan_geturl(params):
    plugintools.log("[HarryTV].mebuscan_geturl( "+repr(params))
