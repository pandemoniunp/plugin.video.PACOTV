...
def resolve_iguide(params):
    plugintools.log("[HarryTV-0.3.0].resolve_iguide " + repr(params) )
...
def resolve_ucaster(params):
    plugintools.log("[HarryTV-0.3.0].resolve_ucaster " + repr(params) )
...
def play_iguide(iguide_palco, iguide_user):
    plugintools.log("[HarryTV-0.3.0].iGuide HarryTV= " + repr(iguide_palco) )
    plugintools.log("[HarryTV-0.3.0].iGuide User= " + repr(iguide_user) )
    ...
    xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('HarryTV', msg, 3 , art+'icon.png'))  

    playlist.add(url_user)
    plugintools.log("[HarryTV 0.2.87b playing URL playlist... "+url_palco)
    playlist.add(url_palco)
    plugintools.log("[HarryTV 0.2.87b fixing URL by HarryTV... "+url_refixed)
    playlist.add(url_refixed)
    plugintools.log("[HarryTV 0.2.87b parsing URL... "+url_user)
