...
def freebroadcast(params):
    plugintools.log("[HarryTV-0.3.0].freebroadcast "+repr(params))
    url_user = {}
...
def getparams_freebroadcast(url_user, body):
    plugintools.log("[HarryTV-0.3.0].getparams_freebroadcast " + repr(url_user) )
...
def getfile_freebroadcast(url_user, decoded, body):
    plugintools.log("HarryTV getfile_freebroadcast( "+repr(url_user))
    referer = url_user.get("referer")
...
def get_fileserver(decoded, url_user):
    plugintools.log("HarryTV fileserver "+repr(url_user))
