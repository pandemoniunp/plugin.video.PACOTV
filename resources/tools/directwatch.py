...
def directwatch(params):
    plugintools.log("[HarryTV-0.3.0].directwatch "+repr(params))
    url_user = {}
...
def nstr(pageurl,ref,body):
    plugintools.log("[HarryTV 0.3.0].nstr")
...
def gethttp_headers(pageurl, referer):
    plugintools.log("[HarryTV-0.3.0].gethttp_headers "+pageurl)
