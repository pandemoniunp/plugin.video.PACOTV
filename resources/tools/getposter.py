# -*- coding: utf-8 -*-
#------------------------------------------------------------
# HarryTV GetPoster (módulo de descarga de posters de películas)
...
#tools = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.HarryTV/tools', ''))
...
def save_title(title, datamovie, filename):
    plugintools.log("HarryTV Saving data... "+repr(datamovie))
...
def save_url(url, filename):
    plugintools.log("HarryTV Saving URL...")
