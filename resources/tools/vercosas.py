# -*- coding: utf-8 -*-
#------------------------------------------------------------
# HarryTV Regex de vercosasgratis.com
...
def vercosas(params):
    plugintools.log("[HarryTV-0.3.0].Vercosasgratis "+repr(params))
    url_user = {}
...
def getparams_vercosas(url_user, body):
    plugintools.log("[HarryTV-0.3.0].getparams_vercosas " + repr(url_user) )
