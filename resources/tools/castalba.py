...
home = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.HarryTV-wip-wip/', ''))
tools = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.HarryTV-wip-wip/resources/tools', ''))
addons = xbmc.translatePath(os.path.join('special://home/addons/', ''))
resources = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.HarryTV-wip-wip/resources', ''))
art = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.HarryTV-wip-wip/art', ''))
tmp = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.HarryTV-wip-wip/tmp', ''))
...
# En construcción!
def castalba(params):
    plugintools.log("[HarryTV-0.3.0].castalba "+repr(params))
...
def castalba(params):
    ...
    if body.find("THIS CHANNEL IS CURRENTLY OFFLINE") > 0 :
        xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('HarryTV', "Canal offline", 3 , art+'icon.png'))
        return 0
    else:
