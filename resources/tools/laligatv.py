...
def laligatv(params):
    plugintools.log("[HarryTV-0.3.0].laligatv.es Playlist Sport Channels( "+repr(params))
...
def adelante_geturl(params):
    plugintools.log("[HarryTV-0.3.0].LaLigatv.es getURL: "+repr(params))
