...
def load_more_vids(params):
    plugintools.log("HarryTV.gethttp_headers "+repr(params))
    ...
    for entry in matches:
        ...
        #plugintools.log("vid_title= "+vid_title)
        ...
        #plugintools.log("vid_thumb= "+vid_thumb)
        i = int(i) + 1
        print i
