...
def get_server(params):
    plugintools.log("[HarryTV 0.3.2].get_server " + repr(params))
...
def url_analyzer(url):
    plugintools.log("[HarryTV 0.3.2 URL_Analyzer "+url)

    if url.startswith("goear") == True:
...
def youtube_playlists(url):
    plugintools.log("[HarryTV 0.3.2].youtube_playlists "+repr(params))
...
def youtube_videos(url):
    plugintools.log("[HarryTV 0.3.2].youtube_videos "+url)
...
def multiparser(params):
    plugintools.log("[HarryTV-0.3.0.Multiparser" +repr(params))
