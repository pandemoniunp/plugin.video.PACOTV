...
def torrentone(params):
    plugintools.log("[HarryTV-0.3.0].Playlist Sport Channels Torrent1( "+repr(params))
...
def gethash_torrentone(params):
    plugintools.log("[HarryTV-0.3.0].gethash_torrentone( "+repr(params))
