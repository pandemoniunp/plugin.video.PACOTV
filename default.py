# -*- coding: utf-8 -*-
#------------------------------------------------------------
# HarryTV - XBMC Add-on by HarryElSuzio 
...
home = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.PACOTV/', ''))
tools = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.PACOTV/resources/tools', ''))
addons = xbmc.translatePath(os.path.join('special://home/addons/', ''))
art = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.PACOTV/art', ''))
tmp = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.PACOTV/tmp', ''))
...
def main_list(params):
    plugintools.log("[PACOTV-0.3.0].main_list "+repr(params))
  
    # Control del skin de HarryTV
    mastermenu = xml_skin()
    plugintools.log("XML menu: "+mastermenu)
    try:
        data = plugintools.read(mastermenu)
    except:
        mastermenu = 'http://pastebin.com/raw.php?i=W9jbJhtZ'
        data = plugintools.read(mastermenu)
        xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('PACOTV', "XML no reconocido...", 3 , art+'icon.png'))    
    ...
    for entry in matches:
        ...
        if pekes_no == "true" :
            ...
            if title.find("[COLOR blue][B]                                                  --[/B][/COLOR][COLOR yellow][B]ADULTOS[/B][/COLOR][COLOR blue][B]--[/B][/COLOR]") >= 0 :
...
def play(params):
    plugintools.log("[PACOTV-0.3.0].play "+repr(params))
...
def live_items_withlink(params):
    plugintools.log("[PACOTV-0.3.0].live_items_withlink "+repr(params))
...
def xml_lists(params):
    plugintools.log("[PACOTV-0.3.0].xml_lists "+repr(params))
    data = plugintools.read( params.get("url") )
...
def getstreams_now(params):
    plugintools.log("[PACOTV-0.3.0].getstreams_now "+repr(params))
...
def livestreams_channels(params):
    plugintools.log("[PACOTV-0.3.0].livestreams_channels "+repr(params))
    data = plugintools.read( params.get("url") )
...
def livestreams_subchannels(params):
    plugintools.log("[PACOTV-0.3.0].livestreams_subchannels "+repr(params))
...
def livestreams_subitems(params):
    plugintools.log("[PACOTV-0.3.0].livestreams_subitems "+repr(params))
...
def livestreams_items(params):
    plugintools.log("[PACOTV-0.3.0].livestreams_items "+repr(params))
...
def xml_items(params):
    plugintools.log("[PACOTV-0.3.0].xml_items "+repr(params))
    data = plugintools.read( params.get("url") )
    thumbnail = params.get("thumbnail")
...
def simpletv_items(params):
    plugintools.log("[PACOTV-0.3.0].simpletv_items "+repr(params))
    ...
    if title == 'search.txt':
        ...
        data = file.readline()
        if data == "":
            ok = plugintools.message("PACOTV", "Sin resultados")
            return ok
    else:
        title = params.get("title")
        ...
        if data.startswith("#EXTINF:-1") == True:
            ...
            if data != "":
                ...
                if url == "#multiparser":
                    ...
                    if cat == "":
                        if busqueda == 'search.txt':
                            plugintools.add_item( action = "multiparser" , plot = plot , extra = filename , title = '[COLOR white]' + title + ' [COLOR lightyellow][Multiparser][/COLOR][COLOR white][I] (' + origen + ')[/I][/COLOR]', show = show , url = url , info_labels = datamovie , thumbnail = thumbnail , fanart = fanart , folder = True , isPlayable = False )
                            plot = ""
                        else:
                            plugintools.add_item( action = "multiparser" , plot = plot , extra = filename , title = '[COLOR white]' + title + ' [COLOR lightyellow][Multiparser][/COLOR]', url = url ,  thumbnail = thumbnail, info_labels = datamovie , show = show , fanart = fanart , folder = True , isPlayable = False )
                            if saving_url == 1:
                                save_url(url, filename)
                                data = file.readline()
                                i = i + 1
                        ...
                        if busqueda == 'search.txt':
                            plugintools.add_item( action = "multiparser" , plot = plot , extra = filename , title = '[COLOR red][I]' + cat + ' / [/I][/COLOR][COLOR white] ' + title + ' [COLOR purple][Multiparser][/COLOR][COLOR white][I] (' + origen + ')[/I][/COLOR]' , url = url , info_labels = datamovie , thumbnail = thumbnail, show = show, fanart = fanart , folder = True , isPlayable = False )                           
                            plot = ""
                        else:
                            plugintools.add_item( action = "multiparser" , plot = plot , extra = filename , title = '[COLOR red][I]' + cat + ' / [/I][/COLOR][COLOR white] ' + title + ' [COLOR purple][Multiparser][/COLOR]' , url = url , info_labels = datamovie , thumbnail = thumbnail, show = show, fanart = fanart , folder = True , isPlayable = False )
                            if saving_url == 1:
                                save_url(url, filename)
                                saving_url = 0                            
                            plot = ""                            
                    ...
                    if cat != "":  # Controlamos el caso de subcategoría de canales
                        if busqueda == 'search.txt':
                            if url.startswith("serie") == True:
                                ...
                                title = title[0]
                                title = title.strip()
                                plugintools.add_item( action = "play" , title = '[COLOR white]' + title + '[COLOR lightblue] [HTTP][/COLOR][I][COLOR lightsalmon] (' + origen + ')[/COLOR][/I]', info_labels = datamovie , url = url , extra = show , show = show , thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True )
                                data = file.readline()
                                i = i + 1
                                continue
                        else:
                            if url.startswith("serie") == True:
                                ...
                                plugintools.add_item( action = "play" , title = '[COLOR red][I]' + cat + ' / [/I][/COLOR][COLOR white] ' + title + '[COLOR blue] [HTTP][/COLOR]' , url = url , plot = plot , extra = show , show = show , thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True )                                
                                data = file.readline()
                                i = i + 1
                                continue
                ...
                # Youtube playlist & channel    
                    ...
                    if data.startswith("yt_playlist") == True:
                        ...
                        if busqueda == 'search.txt':
                            ...
                            plugintools.add_item( action = "yt_playlists" , title = '[[COLOR white]' + title + ' [COLOR red][You[COLOR white]Tube Channel][/COLOR] [I][COLOR lightblue](' + origen + ')[/I][/COLOR]', url = url ,  thumbnail = thumbnail , fanart = fanart , show = show, folder = True , isPlayable = False )
                            data = file.readline()
                            i = i + 1
                            continue
                        else:
                            ...
                            url = 'http://gdata.youtube.com/feeds/api/users/' + youtube_channel + '/playlists?v=2&start-index=1&max-results=30'
                            plugintools.log("url= "+url)                            
                            plugintools.add_item( action = "yt_playlists" , title = '[COLOR white]' + title + ' [COLOR red][You[COLOR white]Tube Channel][/COLOR]', url = url ,  thumbnail = thumbnail , fanart = fanart , show = show, folder = True , isPlayable = False )
                            data = file.readline()
                            i = i + 1
                            continue
                    ...
                    if busqueda == 'search.txt':
                        ...
                        if data.startswith("desc=") == True:
                            ...
                            plot = data
                            plugintools.log("SHOW= "+show)
                            plugintools.add_item( action = "getfile_http" , title = title + ' [COLOR orange][Lista [B]M3U[/B]][/COLOR]', plot = plot , url = url ,  thumbnail = thumbnail , fanart = fanart , show = show, folder = True , isPlayable = False )
                            data = file.readline()
                            i = i + 1
                            continue
                        else:
...
def myplaylists_m3u(params):  # Mis listas M3U
    plugintools.log("[PACOTV-0.3.0].myplaylists_m3u "+repr(params))
    thumbnail = params.get("thumbnail")
...
def playlists_m3u(params):  # Biblioteca online
    plugintools.log("[PACOTV-0.3.0].playlists_m3u "+repr(params))
    ...
    params["ext"] = 'm3u'
    plugintools.add_item( action="" , title='[B][COLOR yellow]'+name_channel+'[/B][/COLOR] - [B][I][COLOR lightyellow] [/COLOR][/B][/I]' , thumbnail= art + 'icon.png' , folder = False , isPlayable = False )    
...
def getfile_http(params):  # Descarga de lista M3U + llamada a simpletv_items para que liste los items
    plugintools.log("[PACOTV-0.3.0].getfile_http "+repr(params))
    url = params.get("url")
    params["ext"] = "m3u"
    getfile_url(params)
...
def getfile_url(params):
    plugintools.log("[PACOTV-0.3.0].getfile_url " +repr(params))
    ext = params.get("ext")
    title = params.get("title")
...
def header_xml(params):
    plugintools.log("[PACOTV-0.3.0].header_xml "+repr(params))
...
def search_channel(params):
    plugintools.log("[PACOTV-0.3.0].search " + repr(params))
    ...
    if buscar == "":
        ...
        cat = ""
        if texto == "":
            errormsg = plugintools.message("PACOTV","Por favor, introduzca el canal a buscar")
            return errormsg
...
def agendatv(params):
    plugintools.log("[PACOTV-0.3.0].agendatv "+repr(params))
...
def plx_items(params):
    plugintools.log("[PACOTV-0.3.0].plx_items" +repr(params))
            ...
            while data <> "" :
                if data.startswith("#") == True:
                    ...
                    if url.startswith("yt_channel") == True:
                        ...
                        youtube_channel = youtube_channel.replace(")", "")
                        url = 'http://gdata.youtube.com/feeds/api/users/' + youtube_channel + '/playlists?v=2&start-index=1&max-results=30'
                        plugintools.add_item(action="yt_playlist" , title = title + ' [[COLOR red]You[COLOR white]tube Channel][/COLOR]', extra = show, url = url , thumbnail = thumbnail , fanart = fanart , folder = True , isPlayable = False)
                        break
                        ...
                        plugintools.log("youtube_playlist= "+youtube_playlist)
                        url = 'https://www.youtube.com/playlist?list='+youtube_playlist
                        plugintools.add_item( action = "yt_playlist" , title = title + ' [COLOR red][You[COLOR white]tube Playlist][/COLOR] [I][COLOR lightblue][/I][/COLOR]', extra = show, url = url ,  thumbnail = art + "icon.png" , fanart = art + 'fanart.jpg' , folder = True , isPlayable = False )
                        data = file.readline()
                        i = i + 1
                        break
...
def futbolenlatv(params):
    plugintools.log("[PACOTV-0.3.0].futbolenlaTV "+repr(params))
...
def encode_string(txt):
    plugintools.log("[PACOTV-0.3.0].encode_string: "+txt)
...
def splive_items(params):
    plugintools.log("[PACOTV-0.3.0].SPlive_items "+repr(params))
    data = plugintools.read( params.get("url") )
...
def p2p_items(params):
    plugintools.log("[PACOTV-0.3.0].p2p_items" +repr(params))
    ...
    data = plugintools.read("http://pastebin.com/raw.php?i=W9jbJhtZ")
    ...
    # Controlamos el caso en que no haya thumbnail en el menú de PACOTV
    if thumbnail == "":
...
def contextMenu(params):
    plugintools.log("[PACOTV-0.3.0].contextMenu " +repr(params))
    ...
    if len_canales == 1:        
        ...
        if len_canales == 2:
            ...
            selector = dialog.select('PACOTV', [tv_a, tv_b])
            ...
            selector = dialog.select('PACOTV', [tv_a, tv_b, tv_c])
            ...
            selector = dialog.select('PACOTV', [tv_a, tv_b, tv_c, tv_d])
            ...
            selector = dialog.select('PACOTV', [tv_a, tv_b, tv_c, tv_d, tv_e])
            ...
            selector = dialog.select('PACOTV', [tv_a , tv_b, tv_c, tv_d, tv_e, tv_f])
            ...
            selector = dialog.select('PACOTV', [tv_a , tv_b, tv_c, tv_d, tv_e, tv_f, tv_g])
...
def magnet_items(params):
    plugintools.log("[PACOTV-0.3.0].magnet_items" +repr(params))
...
def parser_title(title):
    plugintools.log("[PACOTV 0.3.2].parser_title " + title)
...
def json_items(params):
    plugintools.log("[PACOTV-0.3.0].json_items "+repr(params))
    data = plugintools.read(params.get("url"))
...
def youtube_playlists(params):
    plugintools.log("[PACOTV-0.3.0].youtube_playlists "+repr(params))
...
def youtube_videos(params):
    plugintools.log("[PACOTV-0.3.0].youtube_videos "+repr(params))
...
def server_rtmp(params):
    plugintools.log("[PACOTV-0.3.0].server_rtmp " + repr(params))
...
def launch_rtmp(params):
    plugintools.log("[PACOTV-0.3.0].launch_rtmp " + repr(params))
    ...
    if title.endswith("[9stream]") == True:
        ...
        #msg = pDialog.create('PACOTV', 'Intentando reproducir RTMP...')
        plugintools.play_resolved_url(url)
        #xbmc.sleep(15000)
...
def peliseries(params):
    plugintools.log("[PACOTV-0.3.0].peliseries " +repr(params))
...
def tinyurl(params):
    plugintools.log("[PACOTV-0.3.0].tinyurl "+repr(params))
    ...
    xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('HarryTV', "Redireccionando enlace...", 3 , art+'icon.png'))
...
def longurl(params):
    plugintools.log("[PACOTV-0.3.0].longURL "+repr(params))
...
def m3u_items(title):
    plugintools.log("[PACOTV-0.3.0].m3u_items= "+title)
...
def xml_skin():
    plugintools.log("[PACOTV-0.3.0].xml_skin")
    ...
    # values="HarryTV+|Latino Total|Pastebin|Personalizado|Sebas|Halloween"
    if xmlmaster == 'true':               
        if SelectXMLmenu == '0':  # HarryTV+
            mastermenu = 'http://pastebin.com/raw.php?i=W9jbJhtZ'            
            plugintools.log("[PACOTV.xml_skin: "+SelectXMLmenu)
        ...
        elif SelectXMLmenu == '1':   # Latino Total            
            mastermenu = 'http://pastebin.com/raw.php?i=W9jbJhtZ'
            if mastermenu == "":
                plugintools.log("[PACOTV.xml_skin: No definido")
                mastermenu = 'http://pastebin.com/raw.php?i=W9jbJhtZ'  # Cargamos WIP                  
                # Control para ver la intro de HarryTV
                ver_intro = plugintools.get_setting("ver_intro")
                if ver_intro == "true":
                    xbmc.Player(xbmc.PLAYER_CORE_AUTO).play(art + 'intro.mp4')

        elif SelectXMLmenu == '2':  # Pastebin
            ...
            if id_pastebin == "":
                ...
                plugintools.log("[HarryTV.xml_skin: "+mastermenu)

        elif SelectXMLmenu == '3':   # Personalizado            
            mastermenu = 'http://pastebin.com/raw.php?i=W9jbJhtZ'
            if mastermenu == "":
                plugintools.log("[PACOTV.xml_skin: No definido")
                mastermenu = 'http://pastebin.com/raw.php?i=W9jbJhtZ'                
        ...
        elif SelectXMLmenu == '4':  # El mundo de Sebas
            mastermenu = 'http://pastebin.com/raw.php?i=W9jbJhtZ'
            plugintools.log("[PACOTV.xml_skin: "+SelectXMLmenu)
        ...
        elif SelectXMLmenu == '5':   # Halloween
            mastermenu = 'http://pastebin.com/raw.php?i=W9jbJhtZ'
            if mastermenu == "":
                plugintools.log("[PACOTV.xml_skin: No definido")
                mastermenu = 'http://pastebin.com/raw.php?i=W9jbJhtZ'  # Cargamos XML por defecto                  
                # Control para ver la intro de HarryTV
                ver_intro = plugintools.get_setting("ver_intro")
                if ver_intro == "true":
                    xbmc.Player(xbmc.PLAYER_CORE_AUTO).play(art + 'intro.mp4')
...
def multilink(params):
    plugintools.log("[PACOTV-0.3.0.Multilink" +repr(params))
...
def add_playlist(params):
    plugintools.log("[PACOTV-0.3.1].add_playlist "+repr(params))
...
def launch_torrent(url):
    plugintools.log("PACOTV launch_torrent: "+url)
